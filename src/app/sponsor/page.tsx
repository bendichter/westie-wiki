  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="prose-wcs space-y-4">
        ...
        <ul>
          <li>
            A named sponsor card with your name, one-line pitch, and link, shown in the sidebar of
            the home page and <em>every move page</em> on the site.
          </li>
          <li>Click-through counts reported to you monthly.</li>
          <li>
            Clear &ldquo;Sponsor&rdquo; labeling. No pop-ups, no tracking scripts, and no user data,
