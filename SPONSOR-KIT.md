...
with a fully-targeted audience. Revisit rates when real analytics exist — anchor to roughly
...
- Payment collection is manual (invoice/PayPal/Zelle — your choice); nothing is built in.
